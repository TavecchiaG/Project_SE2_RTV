...
\begin{figure}[h]
\begin{center}
\includegraphics[width=\textwidth, height=0.8\textheight, keepaspectratio]{/home/francesco/git/Project_SE2_RTV/DD/DD_images/BCE.png}
\caption{BCE - In this diagram the cardinality referred to the \emph{Entity} are opposite with respect to the \emph{ER diagram}.}
\label{fig:BCE}
\end{center}•
\end{figure}
\clearpage
